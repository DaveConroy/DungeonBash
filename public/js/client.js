function onLoadHandler() {
	...
	*/
	...
	var socketio = io.connect("http://daveconroy-dungeongame.rhcloud.com:8000");
	...
	var stage = new PIXI.Stage(0xEEFFFF, interactive);
	var gameView = document.getElementById('gameCanvas');
	var renderer = PIXI.autoDetectRenderer(STAGE_WIDTH, STAGE_HEIGHT, gameView);
	...
	function inputSetup() {   
		document.getElementById('gameCanvas').addEventListener('movemouse', onMouseMove);
			alert("Hello! I am an alert box!!");
		document.getElementById('gameCanvas').addEventListener('keydown', onKeyDown);		
	}
